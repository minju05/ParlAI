...
class InteractiveWorld(DialogPartnerWorld):
    ...
    Used for models trained on the task `-t wizard_of_wikipedia_ko`. Automatically
    ...
    def _load_topics(self, opt):
        ...
        topics_path = os.path.join(
            opt['datapath'], 'wizard_of_wikipedia_ko', 'topic_splits.json'
        )
    ...
    def _add_knowledge_to_act(self, act):
        ...
        if self.print_checked_sentence:
            print(
                '[ Using chosen sentence from Wikipedia ]: {}'.format(
